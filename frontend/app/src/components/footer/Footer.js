                        ...
                        <div className="footer-column3">
                            ...
                            <div className="footer-social-links">
                                <div className="footer-link14">
                                    ...
                                    <a className="social-links" href="https://www.facebook.com/profile.php?id=61565357090815"><span className="thq-body-small">Facebook</span></a>
                ...
                <div className="footer-credits">
                    ...
                    <div className="footer-row">
                        ...
                        <div className="footer-footer-links3">
                            <span className="thq-body-small cc-1">© 2025 Меморијален турнир во мал фудбал - Андреј Митев</span>
                            <span className="thq-body-small cc-2">Изработено од: Никола Арсов</span>
